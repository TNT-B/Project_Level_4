    ...
    <Space className='aboutus'
        ...
        <Row gutter={16} align="middle" style={{paddingTop:'50px'}}>
            <Col span={6}>
                ...
                <img className='iconaboutus' src='../img/iconshop.jpg'/>
            ...
            <Col span={6}>
                ...
                <img className='iconaboutus' src='../img/icontrans.jpg'/>
            ...
            <Col span={6}>
                <Card size="large" align="center">
                <img className='iconaboutus' src='../img/iconcus.png'/>
            ...
            <Col span={6}>
                <Card size="large" align="center">
                <img className='iconaboutus' src='../img/iconjob.png'/>
